...
},{"../tags/hello-form.html":4,"../tags/hello-world.html":5,"./math":3,"riot":1}],3:[function(require,module,exports){
module.exports.add = (x, y) => {
  return x + y;
}
},{}],4:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag2('hello-form', '<form onsubmit="{sayHello}"> <input type="text" name="greet"> <button>Say Hello</button> </form> <hello-world show="{this.greeting}" greet="{this.greeting}"></hello-world>', '', '', function(opts) {
    ...
    var math = require('../scripts/math');
    var result = math.add(4, 3);
